      ...
      <div class="col-md-12">
        <table class="table table-bordered table-hover">
          ...
          <tr>
            ...
            <td>
              Attributes from enclosed element which will be copied to the 'yes' button. Intended for copy a URL to
              the 'yes' button, but it is customizable.
            </td>
          </tr>
          <tr>
            ...
            <td>
              Messages displayed within the confirmation dialogue. All or part of the object properties may be included;
              any missing will be displayed per the default values. This design is intended to make multi-language
